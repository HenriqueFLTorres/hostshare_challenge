    ...
    <>
      <header className='hidden md:flex px-10 2xl:px-20 py-4 border-y border-secondary w-full'>
        <div className='flex items-center justify-between w-full max-w-[160rem]'>
          ...
          <nav className='flex basis-52 shrink-0 grow items-center justify-end'>
            <button aria-label='Host your home' className='hover:bg-gray-100 shrink-0 p-3 text-sm text-neutral-800 rounded-full motion-safe:transition-colors duration-500'>
              Hostshare your home
            </button>
            <button aria-label='Language settings' className='hover:bg-gray-100 p-3 text-neutral-800 rounded-full motion-safe:transition-colors duration-500'>
              <Globe className='w-4 h-4 fill-neutral-800' />
            </button>
            <button aria-label='Profile menu' className='flex items-center gap-3 ml-1 hover:shadow-md motion-safe:transition-shadow duration-500 border border-secondary rounded-full p-1 pl-3'>
      ...
      <header className='flex md:hidden px-6 pt-3 w-full'>
        <div className='flex w-full min-w-[18rem] items-center rounded-full shadow-md shadow-black/5 border border-secondary'>
          <button aria-label='Search' className='flex items-center grow p-2'>
          ...
          <button aria-label='Filters' className='border shrink-0 w-8 m-2 h-8 rounded-full grid place-items-center border-secondary'>
